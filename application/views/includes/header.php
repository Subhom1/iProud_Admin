...
<!------(header-modeular-start)-------->
<!DOCTYPE html>
<html lang="en" class="gr__demos_creative-tim_com"><head>
  <meta charset="utf-8">
...
<body class="" data-gr-c-s-loaded="true">
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0" href="<?php echo base_url();?>index.php/pages/dashboard">
        <img src="<?php echo base_url();?>assets/img/brand/pink.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
        ...
        <div class="navbar-collapse-header d-md-none">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="<?php echo base_url();?>index.php/pages/dash">
                <img src="<?php echo base_url();?>assets/img/brand/pink.png">
              </a>
            </div>
