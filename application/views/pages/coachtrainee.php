...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
   <div class="container-fluid">
      ...
      <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?php echo base_url();?>index.php/pages/trainee">Coach Trainee</a>
      </div>
      <!-- User -->
   ...
   <div class="row mt-5 justify-content-center">
      <div class="col-xl-10 mb-5 mb-xl-0">
         ...
         <div class="card-body bg-white shadow-lg px-5 mb-0">
           <?php if(count($coachtrainee)==0){?><h3 class="text-danger font-weight-light text-center">No Trainee Found</h3><?php }else{?>                
            <?php foreach($coachtrainee as $row){?>
            <div class="row">
<div class="col-md-10 col-sm-10">
    <div class="row justify-content-center">
               
               <div class="col-lg-4"><div class="row mb-2 justify-content-center">
                  <div class="col-sm-4">
            ...
            <div class="col-md-2 col-sm-2">
                  <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-160px, 31px, 0px);">
                          ...
                          <a class="dropdown-item" href="sendEmail?to=<?php echo base_url();?>"><i class="fas fa-envelope text-danger"></i>Resend Invitation</a>
                          <a class="dropdown-item" href="<?php echo base_url();?>index.php/pages/traineeDelete/<?php echo $row['userid'];?>"><i class="fas fa-trash text-danger"></i>Delete</a>   
                        </div>
                      </div>
